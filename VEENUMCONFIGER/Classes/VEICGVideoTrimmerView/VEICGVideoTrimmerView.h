...
@protocol VEICGVideoTrimmerDelegate;

@interface VEICGVideoTrimmerView : UIView
@property (nonatomic, strong) VEMediaInfo         *contentFile;
...
@property (strong, nonatomic) NSMutableArray< VEComminuteRangeView * > *comminuteRangeViewArray;
...
@property (weak, nonatomic) id<VEICGVideoTrimmerDelegate> delegate;
...
@protocol VEICGVideoTrimmerDelegate <NSObject>
@optional
...
-(void)trimageComminute:(UIImage *) image atFile:(VEMediaInfo *) comminuteFile atRangeViewRect:( CGRect ) rect;

@required
- (void)trimmerView:(VEICGVideoTrimmerView *)trimmerView didChangeLeftPosition:(CGFloat)startTime rightPosition:(CGFloat)endTime;
