...
- (void)prepareLayout {
    ...
    NSAssert(self.dataSource != nil, @"UICollectionViewWaterFallFlowLayout.dataSource cann't be nil.");
...
//    }
    ...
    for (NSInteger section=0; section < numberOfSections; section++) {
        ...
        NSAssert(columnOfSection > 0, @"[UICollectionViewWaterFallFlowLayout collectionView:layout:numberOfColumnInSection:] must be greater than 0.");
