...
-(void)initPentacle:(float) CenterHeight atWidth:(float) CenterWidth
{
    ...
    {
        UIView * view = [[VEOvalView alloc] initWithFrame:CGRectMake( (self.curretnView.frame.size.width - (RoundnessHeight + 60))/2.0, (self.curretnView.frame.size.height - (RoundnessHeight + 60))/2.0, RoundnessHeight + 60, RoundnessHeight + 60) atType:5 atColor:self.mainColor];
