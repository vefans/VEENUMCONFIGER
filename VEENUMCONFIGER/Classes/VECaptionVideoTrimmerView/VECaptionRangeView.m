...
- (void)setSelected:(BOOL)selected {
    ...
    if (selected) {
        ...
        NSString * str = [VEHelp getLocalizedString:kDefaultSubtitleText];
        if (self.file.captionText.length > 0 && ![self.file.captionText isEqualToString:kDefaultSubtitleText] && ![self.file.captionText isEqualToString:str]) {
